...
namespace CiccioSoft.Interop.MariaDb.Native
{
    internal unsafe partial struct st_mysql_stmt
    {
        ...
        // public MySqlFieldNative* fields;
        ...
        // public MySqlBindNative* @params;

        // [NativeTypeName("MYSQL_BIND *")]
        // public MySqlBindNative* bind;
        ...
        // public delegate* unmanaged[Cdecl]<st_mysql_stmt*, byte**, int> fetch_row_func;

        // [NativeTypeName("unsigned int")]
        // public uint execute_count;

        // [NativeTypeName("mysql_stmt_use_or_store_func")]
        // public delegate* unmanaged[Cdecl]<st_mysql_stmt*, nint> default_rset_handler;
        ...
        // public delegate* unmanaged[Cdecl]<void*, MySqlBindNative*, uint, sbyte> param_callback;
