...
- Two-layer architecture:
  - `CiccioSoft.MariaDb`: low-level P/Invoke wrapper around MariaDB Connector/C.
  - `CiccioSoft.Data.MariaDb`: ADO.NET provider layer built on top of the interop layer.
- Supporting projects:
  - `CiccioSoft.MariaDb.Example`: sample usage of the interop layer.
  - `CiccioSoft.Data.MariaDb.Tests`: provider-level tests.
  - `CiccioSoft.MariaDb.Tests`: interop-level tests.
...
- `CiccioSoft.MariaDb.slnx`: solution definition for build/test.
- `CiccioSoft.MariaDb.csproj`: interop layer project.
